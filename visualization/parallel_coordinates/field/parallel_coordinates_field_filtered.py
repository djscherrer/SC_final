...
fig.update_layout(
    title=f'Average ratings of university in all dimensions filter by {field_dict[field_filter]} ({source} data set)',
    title_font_size=20,
...
fig.write_html(f"html/university_{source}_filter_{field_filter}_parallel_coordinates.html")
